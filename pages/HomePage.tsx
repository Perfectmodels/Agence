    ...
    <div className="text-white">
      ...
      <section className="relative h-[90vh] min-h-[600px] flex items-center justify-center text-center bg-black overflow-hidden">
        ...
        <div className="relative z-10 p-6">
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4 animate-fade-in-up">
            <Link to="/mannequins" className="px-8 py-3 bg-brand-gold text-brand-dark font-bold rounded-full hover:bg-yellow-300 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-brand-gold/20">
              Découvrir nos mannequins
            </Link>
            <Link to="/contact" className="px-8 py-3 bg-transparent border-2 border-brand-gold text-brand-gold font-bold rounded-full hover:bg-brand-gold hover:text-brand-dark transition-colors duration-300 transform hover:scale-105">
              Nous Contacter
            </Link>
          </div>
        </div>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            <div className="text-gray-300 text-lg leading-relaxed">
              ...
              <Link to="/a-propos" className="mt-4 inline-block px-6 py-3 border-2 border-brand-gold text-brand-gold font-bold rounded-full hover:bg-brand-gold hover:text-brand-dark transition-colors duration-300">
                En savoir plus &rarr;
              </Link>
            </div>
        </div>
      ...
      >
        ...
        <div className="text-center mt-12">
            <Link to="/mannequins" className="px-8 py-3 bg-brand-gold text-brand-dark font-bold rounded-full hover:bg-yellow-300 transition-colors duration-300 transform hover:scale-105 shadow-lg shadow-brand-gold/20">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto text-center">
            <div className="p-8 border border-brand-gold/20 rounded-lg bg-black/30 transform hover:-translate-y-2 transition-transform duration-300">
        ...
        <div className="text-center mt-12">
            <Link to="/services" className="text-brand-gold font-bold hover:underline">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-brand-dark p-8 rounded-lg border border-gray-800/50">
        ...
        <div className="container mx-auto px-6 text-center">
            <div className="max-w-3xl mx-auto bg-gradient-to-r from-yellow-900/50 to-brand-gold/30 p-10 rounded-lg border border-brand-gold/30">
                ...
                <p className="text-gray-300 text-lg mb-8">
                 ...
                 <Link to="/devenir-mannequin" className="px-10 py-4 bg-brand-gold text-brand-dark font-bold rounded-full hover:bg-yellow-300 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-brand-gold/20">
